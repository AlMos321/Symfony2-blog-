...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->parameters = array(
            ...
            'mailer_user' => 'olegkakyzmin@gmail.com',
            'mailer_password' => 'pas',
            'locale' => 'en',
            'secret' => 'ThisTokenIsNotSoSecretChangeIt',
            'blogger_blog.emails.contact_email' => 'alexmoss09@gmail.com',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'olegkakyzmin@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'pas',
            ...
            'swiftmailer.mailer.default.single_address' => 'alexmoss09@gmail.com',
            'swiftmailer.mailer.default.delivery_whitelist' => array(

            ),
            'swiftmailer.spool.enabled' => true,
            'swiftmailer.delivery.enabled' => true,
            'swiftmailer.single_address' => 'alexmoss09@gmail.com',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'symfony', 'user' => 'root', 'password' => 111, 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => (dirname(dirname(dirname(__DIR__))).'/src/Blogger/BlogBundle/Entity'))), 'Blogger\\BlogBundle\\Entity');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_62864b92167b65f9b3336159ef61dabb593db58ce0885029288718303df61578');
    ...
    {
        $this->services['sensio_distribution.webconfigurator'] = $instance = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator(dirname(dirname(__DIR__)));
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('olegkakyzmin@gmail.com');
        $a->setPassword('pas');
        $a->setAuthMode('login');
    ...
    {
        return $this->services['swiftmailer.plugin.redirecting'] = new \Swift_Plugins_RedirectingPlugin('alexmoss09@gmail.com', array());
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/src/Blogger/BlogBundle/Resources/translations/messages.en.yml'), 'en', 'messages');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/src/Blogger/BlogBundle/Resources/translations/messages.ru.yml'), 'ru', 'messages');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/src/Blogger/BlogBundle/Resources/views'), 'BloggerBlog');
