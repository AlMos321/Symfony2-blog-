...
$catalogue = new MessageCatalogue('ru', array (
  ...
  'messages' => 
  array (
    'title.blog_homepage' => 'Главная',
    'title.title' => 'Last comments',
    'title.about' => 'О нас',
    'title.contact' => 'Контакты',
    'title.main' => 'Main',
    'menu.about' => 'Об symblog',
    'menu.logs' => 'Это руководство поможет вам создать полнофункциональный сайт блога при помощи фреймворка Symfony2.',
  ),
));
...
$catalogueEn = new MessageCatalogue('en', array (
  ...
  'messages' => 
  array (
    'title.blog_homepage' => 'Blog homepage',
    'title.title' => 'Last comments',
    'title.about' => 'About',
